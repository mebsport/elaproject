...
function Credits() {
  return (
    <Sources>
        <a href='https://docs.google.com/document/d/19b87jJMTtvIkgOIAy9yB_otUC7aova9QiPd5BsUY9Uk/edit?usp=sharing'>
        ...
        <SourcesCitedBody>
          Amnesty International. “Police Brutality Is a Global Problem.” Amnesty
